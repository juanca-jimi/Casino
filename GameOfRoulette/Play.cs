...
// This is an unbreakable intuitive game of roullete!
{
    ...
    class Play
    {
        ...
        private static int youWin(int howMuch, int bet)
        {
            Console.WriteLine($"You won {bet * howMuch}!!!\n\tYour your pot is now {howMuch * bet + bet}");
            return howMuch*bet+bet;
        }
        private static void landedOn(int ballLand)
        {
